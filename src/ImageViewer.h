...
private slots:
	...
	void on_ButtonVykreslit_clicked();
	void on_ButtonVycistit_clicked();

	void on_sliderHustota_valueChanged();
	void on_spinHustota_valueChanged(int);

	void on_sliderRozsah_valueChanged();
	void on_spinRozsah_valueChanged(int);
};
